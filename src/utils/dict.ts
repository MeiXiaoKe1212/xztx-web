...
export enum DICT_TYPE {
  ...
  // ========== XZTX - 招聘模块  ==========
  DISABLED_TYPE = 'disabled_type', // 残疾类别
  JOB_TESE = 'job_tese', // 工作特色
  COMPANY_TYPE = 'company_type', // 企业类型
  JOB_TYPE = 'job_type', // 工作类型
  USER_EXP = 'user_exp', // 工作经验
  USER_EDU = 'user_edu', // 学历要求
  JOB_WELFARE = 'job_welfare', // 福利待遇
  JOB_INDUSTRY_TYPE = 'job_industry_type', // 岗位行业类别
