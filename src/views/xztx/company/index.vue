    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['xztx:company:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['xztx:company:export']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['xztx:company:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['xztx:company:delete']"
          >
            删除
          </el-button>
        </template>
...
/** 携智同行 企业 列表 */
defineOptions({name: 'XztxCompany'})
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, '携智同行 企业.xls')
  } catch {
  } finally {
